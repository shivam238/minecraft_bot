...
const state = {
  ...
  lastCombatTarget: null, // last entity pvp was attacking — for chase/re-engage logic
  lastTpaTime: 0,         // last time bot sent /tpa (to prevent spam)
  ...
  politeMode: false,        // When true, bot will NOT attack any player
  ...
  lastFollowGoalTime: 0, // timestamp of last GoalFollow submission — used to detect stuck
  memory: {
    lastAFKActions: [],
    recentPositions: [],
